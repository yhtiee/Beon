  ...
  const loadProfile = useCallback(async () => {
    const profile = await fcl.query({
      cadence: `
        ...
        pub fun main(address: Address): NewAmbassadorProfile.ReadOnly? {
          return NewAmbassadorProfile.read(address)
        }
      `,
      ...
      cadence: `
        ...
        transaction {
          prepare(account: AuthAccount) {
            ...
            if (!NewAmbassadorProfile.check(account.address)) {
              // This creates and stores the profile in the user's account
              account.save(<- NewAmbassadorProfile.new(), to: NewAmbassadorProfile.privatePath)

              // This creates the public capability that lets applications read the profile's info
              account.link<&NewAmbassadorProfile.Base{NewAmbassadorProfile.Public}>(NewAmbassadorProfile.publicPath, target: NewAmbassadorProfile.privatePath)
            }
          }
        }
      `,
